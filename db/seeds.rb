...
cat2 = Article.create!(
  ...
  user_id: 1,
  image_url: '/assets/Grim_Fandango.jpeg',
  category_ids: [1, 2]
)
...
cat3 = Article.create!(
  ...
  user_id: 2,
  image_url: '/assets/final_fantasy.jpg',
  category_ids: 1
)
...
cat4 = Article.create!(
  ...
  user_id: 3,
  image_url: '/assets/Assasins_creed.jpeg',
  category_ids: 1
)
...
cat2 = Article.create!(
  ...
  user_id: 2,
  image_url: '/assets/longest-journey.jpg',
  category_ids: 2
)
...
cat3 = Article.create!(
  ...
  ",
  user_id: 2,
  image_url: '/assets/machinarium.jpeg',
  category_ids: [2, 5]
)
...
cat4 = Article.create!(
  ...
  user_id: 1,
  image_url: '/assets/curious_village.jpeg',
  category_ids: [2, 5]
)
...
cat1 = Article.create!(
  ...
  user_id: 3,
  image_url: '/assets/ElderScroll.jpeg',
  category_ids: 3
)
...
cat2 = Article.create!(
  ...
  user_id: 1,
  image_url: '/assets/dragon-age.jpg',
  category_ids: 3
)
...
cat2 = Article.create!(
  ...
  user_id: 3,
  image_url: '/assets/stardew_valley.jpeg',
  category_ids: 4
)
cat3 = Article.create!(
  ...
  user_id: 1,
  image_url: '/assets/total_war.jpg',
  category_ids: [4, 5]
)
cat4 = Article.create!(
  ...
  user_id: 3,
  image_url: '/assets/jurassic-world.jpeg',
  category_ids: 4
)
