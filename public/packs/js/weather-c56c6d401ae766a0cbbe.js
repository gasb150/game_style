...
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons */ "./app/javascript/packs/icons.js");
...
var loadPage = function loadPage(t) {
  var load = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(t) {
      var cityInput, data, tempValue, cityName, cityTemp, cityCloud, cityHumidity;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log(t); // const locData = await Location().then((response => {
            ...
            case 4:
              ...
              cityTemp.innerHTML = " ".concat(Math.round(tempValue - 273.15, -1), "\xB0C");
              cityCloud.innerHTML = "<img src=\"http://openweathermap.org/img/wn/".concat(data.weather[0].icon, ".png\"> </img>");
              cityCloud.innerHTML = "<p class=\"w-icon\"> ".concat(Object(_icons__WEBPACK_IMPORTED_MODULE_2__["default"])(data), " </p>");
              cityHumidity.innerHTML = "<div><p class=\"iconify\" data-icon=\"carbon:humidity\" data-inline=\"false\"></p> <p>".concat(data.main.humidity, "%</p></div>");
...
/******/ });
//# sourceMappingURL=weather-c56c6d401ae766a0cbbe.js.map