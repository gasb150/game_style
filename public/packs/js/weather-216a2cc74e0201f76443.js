...
var loadPage = function loadPage(t) {
  var load = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(t) {
      var locData, cityInput, data, tempValue, cityName, cityTemp, cityCloud, cityHumidity, dataIcon;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 7:
              ...
              cityCloud = document.getElementById('cloud');
              ...
              cityTemp.innerHTML = " <span class=\"iconify\" data-icon=".concat(dataIcon, " data-inline=\"false\"></span> ").concat(Math.round(tempValue - 273.15, -1), "\xB0C");
              cityCloud.innerHTML = "<img src=\"http://openweathermap.org/img/wn/".concat(data.weather[0].icon, ".png\"> </img>");
              cityHumidity.innerHTML = "<span class=\"iconify\" data-icon=\"carbon:humidity\" data-inline=\"false\"></span> ".concat(data.main.humidity, "%");
              temp.innerHTML = " <span class=\"iconify\" data-icon=".concat(dataIcon, " data-inline=\"false\"></span> ").concat(Math.round(tempValue - 273.15, -1), "\xB0C");
              tempFeel.innerHTML = " <span class=\"iconify\" data-icon=".concat(dataIcon, " data-inline=\"false\"></span> ").concat(Math.round(tempFeelValue - 273.15, -2), "\xB0C");
...
/******/ });
//# sourceMappingURL=weather-216a2cc74e0201f76443.js.map